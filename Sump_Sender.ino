...
//
//                       Uses ESP8266 Developement board by RobotDyn WiFi D1 R2 32 MiB
//
...
//
//
//  External            Note:  Uses esp8266 by ESP8266 Community version 2.7.1 for "Arduino IDE."
//
///////////////////////////////////////////////////////////////////////////////////////////////////////
...
Serial.println("");
ftpSrv.begin("techno", "qrzab9nq");   //username, password for ftp.  set ports in ESP8266FtpServer.h  (default 21, 50009 for PASV)
